...
# Запрос минимальной и максимальной цены у пользователя
minprice = int(input('Введите минимальную цену: '))
maxprice = int(input('Введите максимальную цену: '))
search_query = input('Введите запрос для обработки: ')
...
if search_query:
    ...
    def extract_product_info(json_data):
        try:
            ...
            rating = script_data.get("ratingValue")
            rating_counter = script_data.get("reviewCount")
    ...
    if __name__ == "__main__":
        ...
        save_to_excel(all_cards, "C:/Users/User/Downloads/ozon_products")
        driver.quit()
